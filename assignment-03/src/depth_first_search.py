...
def depth_first_search(maze_map, start_pos, goal_pos):
    ...
    -------
    [list]
        [returns a list with traversed paths to goals using depth first search ]
    """
...
if __name__ == '__main__':
    ...
    path_map1 = depth_first_search(maze_matrix1, start_pos_map1, goal_pos_map1)
    write_to_file("dfs_map1", path_map1,file_path_result)

    path_map2 = depth_first_search(maze_matrix2, start_pos_map2, goal_pos_map2)
    write_to_file("dfs_map2", path_map2,file_path_result)

    path_map3 = depth_first_search(maze_matrix3, start_pos_map3, goal_pos_map3)
    write_to_file("dfs_map3", path_map3,file_path_result)
...
# [5]https://www.codespeedy.com/depth-first-search-algorithm-in-python/
